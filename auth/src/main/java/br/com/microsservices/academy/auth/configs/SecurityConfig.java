...
public class SecurityConfig extends br.com.microsservices.academy.security.configs.SecurityConfig {
    ...
    public SecurityConfig(JwtProperty jwtProperty, TokenCreatorHelper tokenCreatorHelper, @Qualifier("userDetailsImplementation") UserDetailsService userDetailsService) {
        super(jwtProperty);
